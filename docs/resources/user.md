...
| moderationStatus       | ?string                                                | this user's moderation status (e.g. banned)                           |
...
## Get User Profile
<span class="http-verb">GET</span><span class="http-path">/users/{[user.id](#user-object)}/profilev3</span>

Returns a [user](#user-object) object for a given user ID. This slightly differs from [Get User](#get-user).
